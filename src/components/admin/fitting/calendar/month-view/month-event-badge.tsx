...
export function MonthEventBadge({
  ...
  const itemStartDate = startOfDay(new Date(itemStart));
  const itemEndDate = endOfDay(new Date(itemEnd));
  const cellDateNormalized = startOfDay(cellDate);

  if (cellDateNormalized < itemStartDate || cellDateNormalized > itemEndDate)
    return null;
